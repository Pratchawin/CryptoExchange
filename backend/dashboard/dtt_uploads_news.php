                                    ...
                                    <div class="ar-inp-coin-data">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td class="set-form-ad-nc inp-coin-data"><input class="inp-coin-data-txt" type="text" name="" id=""></td>
                                            </tr>
                                            <tr>
                                                <td class="set-form-ad-nc">ราคาที่เปิดตัว</td>
                                                <td class="set-form-ad-nc inp-coin-data"><input class="inp-coin-data-txt" type="text" name="opn_price" id=""></td>
                                            </tr>
                                            <tr>
